...
- (UITableViewCell *)switchCellWithTitle:(NSString *)title toggleAction:(SEL)toggleAction isOn:(BOOL)isOn
{
    ...
    [cell setBackgroundColor: [UIColor colorWithRed:10.0/255.0 green:10.0/255.0 blue:10.0/255.0 alpha:1.0]];//rgb(38, 37, 42)];
...
- (UITableViewCell *)buttonCellWithTitle:(NSString *)title touchUpAction:(SEL)action isDestructive:(BOOL)isDestructive
{
    ...
    [buttonCell.layer setCornerRadius:10];

    [buttonCell setBackgroundColor: [UIColor colorWithRed:10.0/255.0 green:10.0/255.0 blue:10.0/255.0 alpha:1.0]];//rgb(38, 37, 42)];
    //Border Color and Width
    [buttonCell.layer setBorderColor:[UIColor blackColor].CGColor];
    [buttonCell.layer setBorderWidth:1];

    //Set Text Col
    buttonCell.textLabel.textColor = [UIColor whiteColor];//[prefs colorForKey:@"textTint"];
    buttonCell.detailTextLabel.textColor = [UIColor whiteColor];//[prefs colorForKey:@"textTint"];

    buttonCell.clipsToBounds = YES;
...
- (UITableViewCell *)sliderCellWithTitle:(NSString *)title changedAction:(SEL)changedAction minimum:(CGFloat)minimum maximum:(CGFloat)maximum initialValue:(CGFloat)initialValue
{
    ...
    [sliderCell.layer setCornerRadius:10];

    [sliderCell setBackgroundColor: [UIColor colorWithRed:10.0/255.0 green:10.0/255.0 blue:10.0/255.0 alpha:1.0]];//rgb(38, 37, 42)];
    //Border Color and Width
    [sliderCell.layer setBorderColor:[UIColor blackColor].CGColor];
    [sliderCell.layer setBorderWidth:1];

    //Set Text Col
    sliderCell.textLabel.textColor = [UIColor whiteColor];//[prefs colorForKey:@"textTint"];
    sliderCell.detailTextLabel.textColor = [UIColor whiteColor];//[prefs colorForKey:@"textTint"];

    sliderCell.clipsToBounds = YES;
