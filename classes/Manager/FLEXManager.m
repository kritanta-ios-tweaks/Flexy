...
- (void)showExplorer
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"STOP_IDLE_TIMER" object:nil];
}

- (void)hideExplorer
{
    self.explorerWindow.hidden = YES;
    [[NSNotificationCenter defaultCenter] postNotificationName:@"START_IDLE_TIMER" object:nil];
}
...
- (UIViewController *)topViewController
{
    ...
    topViewController.navigationController.navigationBar.barTintColor = [UIColor blackColor];
    [topViewController.navigationController.navigationBar setTitleTextAttributes:
     @{NSForegroundColorAttributeName:[UIColor redColor],
    NSFontAttributeName:[UIFont fontWithName:@"CircularSpUI-Bold" size:15]}];
